...
namespace Website.Models.DTOs.Properties
{
    public class PropertyDetailDTO
    {
        ...
        [DataType(DataType.Currency), Display(Name = "Monthly Rent"), Range(1, 10000, ErrorMessage = "You cannot charge more than 10000 per month.")] // RegularExpression(@"^(\d{4,})|((\d+(\,|\.))+\d{2,})$", ErrorMessage = "You cannot charge more than 10000 per month."), DisplayFormat(DataFormatString = "{0:#,###0.00}", ApplyFormatInEditMode = true)
